...
<body>
	...
	<h5 class="white-text section center-align hide-on-large-only" style="padding: 15px; background-color: #28d0c8">Kategori Celana</h5>
	<!-- baju title section end -->
	<ul class="collapsible hide-on-large-only">
		<li>
			<div class="collapsible-header">Celana X&nbsp;&nbsp;<span class="fa fa-chevron-circle-down" style="margin-top: 4px;"></span></div>
