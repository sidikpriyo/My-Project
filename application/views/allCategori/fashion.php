...
<head>
	<title>Semua Kategori | Fashion</title>
	...
	<style type="text/css">
		...
		#menu_allCategori {padding: 5px;background: #e6e6e6;}
		#menu_allCategori h6{font-size: 15px; color: black}
		#vm a:hover{ color: black; text-decoration: underline solid #fee12b; font-size: 16px;}

		#body_allCategori a:hover{color: black;text-decoration: underline solid #fee12b; font-size: 15px}
		#body_allCategori a{color: gray; font-size: 14px}
		#body_allCategori li{padding: 5px; margin-left: 12px;}
		#body_allCategori ul{background: white}
...
<body>
	...
	<div class="container" style="background: #e6e6e6; width: 100%; padding: 1px; margin-bottom: 40px; margin-top: 20px;">
		<ul style="margin-top: 10px;">
			<li style="font-size: 14px"><a href="http://localhost/pancakarya/Home">&nbsp;&nbsp;Home</a>&nbsp;>&nbsp;Semua Kategori Fashion</li>
		</ul>
	</div>
	...
	<div class="content" style="margin-top: -10px;">
		<div class="row">
			...
			<?php $this->load->view('template/menu_allCategori'); ?>
				...
				<div class="col" style="border: 1px solid #e6e6e6;background: white; padding: 10px; margin: 5px; width: 79%; margin-left: 15px; margin-top: -10px">
					<div class="row" style="background: #e6e6e6; margin-top: -10px; margin-left: -10px; margin-right: -10px; padding: 1px">
						<h5 style="margin-top: 10px; font-size: 20px">&nbsp;&nbsp;Semua Kategori Fashion</h5>
					</div>
					...
					<div class="content" id="judul">
						<img style="width: 100px;height: 100px;float: left; margin-top: -32px; margin-left: -30px" src="<?= base_url('assets/icon/perempuan.png');?>">
						<h6>&nbsp;&nbsp;Fashion Perempuan</h6>
					</div>
		...
		<a href="http://localhost/pancakarya/Fashion/fashionPerempuan">View More</a>
	</div>
	</div>
					...
					<div class="content" id="judul">
						<img style="width: 100px;height: 100px;float: left; margin-top: -32px; margin-left: -30px" src="<?= base_url('assets/icon/laki.png');?>">
						<h6>&nbsp;&nbsp;Fashion Laki-Laki</h6>
					</div>
...
<!-- fashion Laki-Laki -->
		...
		<div align="right" style="margin-left: 20px; margin-right: 30px; margin-bottom: 20px;" id="vm">
		<a href="http://localhost/pancakarya/Fashion/fashionLaki">View More</a>
	</div>
	</div>
					...
					<div class="content" id="judul">
						<img style="width: 100px;height: 100px;float: left; margin-top: -32px; margin-left: -30px" src="<?= base_url('assets/icon/anak.png');?>">
						<h6>&nbsp;&nbsp;Fashion Anak</h6>
					</div>
	<!-- fashion anak -->
		<div class="row" style="border: 1px solid #e6e6e6; margin-bottom: 30px;">
		...
		<div align="right" style="margin-left: 20px; margin-right: 30px; margin-bottom: 20px;" id="vm">
		<a href="http://localhost/pancakarya/Fashion/fashionAnak">View More</a>
	</div>
	</div>
