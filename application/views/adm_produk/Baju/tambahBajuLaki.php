...
<div id="content">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="http://localhost/pancakarya/Produk/allBaju">Semua Kategori Baju</a></li>
    <li class="breadcrumb-item"><a href="http://localhost/pancakarya/Produk/bajuLaki">Baju Laki-Laki</a></li>
    <li class="breadcrumb-item active" aria-current="page">Tambah Baju Laki-Laki</li>
  </ol>
  </nav>
...
<div class="container">
  <div class="card" style="background-color: white">
    <div class="card-body">
      <div class="content">
        <h4 style="text-align: center;background-color: rgb(0,0,0,0.07); padding: 10px; border-radius: 5px">MENAMBAHKAN DATA BAJU LAKI-LAKI</h4>
      </div>
      <form>
    ...
    <div class="row" style="margin-top: 30px;">
     <div class="col l4 mb-3">
      <label class="col-form-label">Nama Baju</label>
      <input type="text" class="form-control" name="" id="nm_baju" required style="width: 100%">
    </div>
    <div class="col l4 mb-3">
      <label class="col-form-label">Jenis Baju</label>
      <input type="text" class="form-control" name="" id="jns_baju" required style="width: 100%">
    </div>
     <div class="col l4 mb-3">
      <label class="col-form-label">Kategori Baju</label>
      <input type="text" class="form-control" name="" id="kat_baju" required style="width: 100%">
    </div>
    </div>
    ...
    <div class="col l2 mb-3" align="center">
      <label class="col-form-label">XXL</label>
      <input type="text" class="form-control" name="" required style="width: 100%">
    </div>
    </div>
    <h5 align="center" style="margin-top: 30px">Ukuran SS</h5>
    ...
    <h5 align="center" style="margin-top: 30px">Ukuran XXL</h5>
    <div class="row" style="border-bottom: 2px solid gray">
      <div class="col l2 mb-3" align="center">
      <label class="col-form-label">Merah</label>
      <input type="text" class="form-control" name="" required style="width: 100%">
    ...
    <a href="http://localhost/pancakarya/Produk/bajuLaki" class="btn btn-danger"><span class="fa fa-backspace"></span>&nbsp;Kembali</a>
