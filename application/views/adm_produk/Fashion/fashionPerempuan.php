...
<body id="page-top">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Fashion Perempuan</li>
  </ol>
  </nav>
  ...
  <div class="card">
    <div class="card-body">
      <div class="container" align="center" style="background: rgb(0,0,0,0.07); padding: 5px; margin-bottom: 20px;border-radius: 3px"><h4>DATA FASHION PEREMPUAN</h4></div>
      <!-- Tambah Fashion Perempuan Button -->
      <a href="http://localhost/pancakarya/Produk/tambahFashionPerempuan" class="btn btn-success" style="margin-bottom: 10px;"><span class="fa fa-plus"></span>&nbsp;Tambah Fashion Perempuan</a>
   ...
   <table id="tables" class="table table-bordered table-striped table-hover table-datatable">
    ...
    <div class="text-right">
      <a href="http://localhost/pancakarya/Produk/allFashion" class="btn btn-primary" style="margin-bottom: 10px;">Kembali</a>
    </div>
    </div>
  </div>
