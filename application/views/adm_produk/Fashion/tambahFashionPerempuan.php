...
<div id="content">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="http://localhost/pancakarya/Produk/allFashion">Semua Kategori Fashion</a></li>
    <li class="breadcrumb-item"><a href="http://localhost/pancakarya/Produk/fashionPerempuan">Fashion Perempuan</a></li>
    <li class="breadcrumb-item active" aria-current="page">Tambah Fashion Perempuan</li>
  </ol>
  </nav>
...
<div class="container">
  <div class="card" style="background-color: white;">
    <div class="card-body">
      <div class="content">
        <h4 style="text-align: center;background-color: rgb(0,0,0,0.07); padding: 10px; border-radius: 5px;">MENAMBAHKAN DATA FASHION PEREMPUAN</h4>
      </div>
      <form>
    ...
    <div class="row" style="margin-top: 30px;">
     <div class="col l4 mb-3">
      <label class="col-form-label">Nama Fashion</label>
      <input type="text" class="form-control" name="" required style="width: 100%">
    </div>
    <div class="col l4 mb-3">
      <label class="col-form-label">Jenis Fashion</label>
      <input type="text" class="form-control" name="" required style="width: 100%">
    </div>
     <div class="col l4 mb-3">
      <label class="col-form-label">Kategori Fashion</label>
      <input type="text" class="form-control" name="" required style="width: 100%">
    </div>
    </div>
    ...
    <a href="http://localhost/pancakarya/Produk/fashionPerempuan" class="btn btn-danger"><span class="fa fa-backspace"></span>&nbsp;Kembali</a>
