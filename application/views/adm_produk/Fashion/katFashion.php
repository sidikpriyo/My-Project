...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="card-header" align="center" style="background-color: rgb(0,0,0,0.7);"><h4 style="color: #ffee58;" id="font">KATEGORI FASHION</h4></div>
    <div class="card-body"></div>

    <div class="row" style="padding: 20px; margin-bottom: 30px">

    <div class="col-md-4">
      <a href="http://localhost/pancakarya/Produk/fashionPerempuan" style="text-decoration: none;"><div class="card bg-danger text-white">
          <div class="card-body">
    ...
    <div class="col-md-4">
      <a href="http://localhost/pancakarya/Produk/fashionLaki" style="text-decoration: none;"><div class="card bg-success text-white">
          <div class="card-body">
            <div class="pull-right">
    ...
    <div class="col-md-4">
      <a href="http://localhost/pancakarya/Produk/fashionAnak" style="text-decoration: none;"><div class="card bg-primary text-white">
          <div class="card-body">
            <div class="pull-right">
