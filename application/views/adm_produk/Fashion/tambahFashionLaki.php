...
<div id="content">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="http://localhost/pancakarya/Produk/fashionLaki">Fashion Laki-Laki</a></li>
    <li class="breadcrumb-item active" aria-current="page">Tambah Fashion Laki-Laki</li>
  </ol>
  </nav>
...
<div class="container">
  <div class="card" style="background-color: white;">
    <div class="card-body">
      <div class="content">
        <h4 style="text-align: center;background-color: rgb(0,0,0,0.07); padding: 10px; border-radius: 5px;">MENAMBAHKAN DATA FASHION LAKI-LAKI</h4>
      </div>
      <form>
    ...
    <a href="http://localhost/pancakarya/Produk/fashionLaki" class="btn btn-danger"><span class="fa fa-backspace"></span>&nbsp;Kembali</a>
