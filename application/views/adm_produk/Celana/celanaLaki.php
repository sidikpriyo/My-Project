...
<body id="page-top">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Celana Laki-Laki</li>
  </ol>
  </nav>
  ...
  <div class="card">
    <div class="card-body">
      <div class="container" align="center" style="background: rgb(0,0,0,0.07); padding: 5px; margin-bottom: 20px;border-radius: 3px"><h4>DATA CELANA LAKI-LAKI</h4></div>
      <!-- Tambah Celana Laki-Laki Button -->
      <a href="http://localhost/pancakarya/Produk/tambahCelanaLaki" class="btn btn-success" style="margin-bottom: 10px;"><span class="fa fa-plus"></span>&nbsp;Tambah Celana Laki-Laki</a>
