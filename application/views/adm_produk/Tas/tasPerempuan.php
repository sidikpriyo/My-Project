...
<body id="page-top">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Tas Perempuan</li>
  </ol>
  </nav>
  ...
  <div class="card">
    <div class="card-body">
      <div class="container" align="center" style="background: rgb(0,0,0,0.07); padding: 5px; margin-bottom: 20px;border-radius: 3px"><h4>DATA TAS PEREMPUAN</h4></div>
      <!-- Tambah Tas Perempuan Button -->
      <a href="http://localhost/pancakarya/Produk/tambahTasPerempuan" class="btn btn-success" style="margin-bottom: 10px;"><span class="fa fa-plus"></span>&nbsp;Tambah Tas Perempuan</a>
   ...
   <table id="tables" class="table table-bordered table-striped table-hover table-datatable">
    ...
    <div class="text-right">
      <a href="http://localhost/pancakarya/Produk/allTas" class="btn btn-primary" style="margin-bottom: 10px;">Kembali</a>
    </div>
    </div>
  </div>
